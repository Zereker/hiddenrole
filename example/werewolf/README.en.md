...
[繁中/简中 README](README.md) · English · [the kernel](../../README.md)
...
> this package implements the Chinese ruleset, and its comments are in Chinese
> for the same reason. The kernel underneath is [hiddenrole](../../README.md),
> the root package of this repository, and it is in English.
...
[`types.go`](../../types.go): the kernel's whole vocabulary is five

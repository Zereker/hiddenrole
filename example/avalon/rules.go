// Package avalon 是这个引擎的第二套规则：抵抗组织·阿瓦隆。
//
...
// Replay 按日志重建一局阿瓦隆。
//
// 参数从 []*Effect 换成 *GameLog：日志现在是可持久化的记录，自带格式版本号，
// 而不再只是进程内的一串对象。
func Replay(log *hiddenrole.GameLog, extra ...hiddenrole.EngineOption) (*hiddenrole.Engine, error) {

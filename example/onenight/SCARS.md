...
|---|---|---|---|
| 1 | a target must be a player, so "look at a card" is inexpressible | missing capability | ✅ [DESIGN §8.2](../../DESIGN.md) called it |
...
| 5 | victory can only have one winner | missing capability | ✅ [DESIGN §8.2](../../DESIGN.md) called it |
